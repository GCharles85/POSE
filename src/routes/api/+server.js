...
import { createReadableStream, getRequest, setResponse } from '../../../node_modules/@sveltejs/kit/src/exports/node/index.js';
 ...
 */
export async function _dev(vite, vite_config, svelte_config) {
	installPolyfills();
